    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-xl font-semibold text-stone-900">Ajouter une voiture</h1>
                    <p className="text-sm text-stone-500 mt-0.5">Remplissez les informations du véhicule</p>
                </div>
            </div>
