...
// Formulaire de modification d'un service existant : pré-remplit les champs depuis l'API puis envoie les changements.
export default function ModifierService() {
    ...
    useEffect(() => {
        api.get('/services')
            .then(res => {
                const service = res.data.find(s => String(s.id) === id);
    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-xl font-semibold text-stone-900">Modifier le service</h1>
                    <p className="text-sm text-stone-500 mt-0.5">Mettez à jour les informations du service</p>
                </div>
            </div>
