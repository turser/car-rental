...
// Formulaire d'ajout d'une assurance, liée à une voiture existante.
export default function AjouterAssurance() {
    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-xl font-semibold text-slate-900">Ajouter une assurance</h1>
                    <p className="text-sm text-slate-500 mt-0.5">Remplissez les informations du contrat</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                    <h2 className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
                        <i className="ti ti-shield-check text-blue-500" /> Détails du contrat
                    </h2>
