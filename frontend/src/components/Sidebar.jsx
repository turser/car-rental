...
export default function Sidebar() {
    ...
    return (
        <aside className="flex flex-col w-60 h-screen fixed inset-y-0 left-0 bg-white text-slate-700 border-r border-slate-200 overflow-hidden">

            {/* Logo */}
            <div className="flex items-center gap-2.5 px-4 py-5 flex-shrink-0 border-b border-slate-100">
                ...
                <p className="font-bold text-slate-900 text-[15px] tracking-wide uppercase">CarRental</p>
            </div>
            ...
            <div className="px-3 py-3 border-t border-slate-100 flex-shrink-0">
                {user && (
                    <button
                        ...
                        className="flex items-center gap-2.5 px-3 py-2 rounded-lg mb-0.5 w-full text-left hover:bg-slate-50 transition-colors"
                    >
                        <div className="w-7 h-7 rounded-full bg-blue-50 text-blue-700 flex items-center justify-center text-[11px] font-bold flex-shrink-0">
                            {initials}
                        </div>
