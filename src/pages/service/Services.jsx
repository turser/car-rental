        ...
        <div>
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-0.5">{services.length} services enregistrés</p>
                </div>
                <button
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {filtered.map(s => (
                                <tr key={s.id} className="hover:bg-slate-50/70 transition-colors">
                                    <td className="px-5 py-3.5 font-medium text-slate-900">{s.serviceName}</td>
                                    <td className="px-5 py-3.5 text-slate-600">{PRICE_TYPE_LABELS[s.priceType] || s.priceType}</td>
                                    <td className="px-5 py-3.5 text-slate-600">{fmtPrice(s.price)}</td>
