    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-xl font-semibold text-slate-900">Ajouter un client</h1>
                    <p className="text-sm text-slate-500 mt-0.5">Remplissez les informations du client</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                    <h2 className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
                        <i className="ti ti-user text-indigo-500" /> Identité
                    </h2>
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                    <h2 className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
                        <i className="ti ti-address-book text-indigo-500" /> Contact
                    </h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
