    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-xl font-semibold text-slate-900">Modifier la maintenance</h1>
                    <p className="text-sm text-slate-500 mt-0.5">Mettez à jour les informations de l'intervention</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                    <h2 className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
                        <i className="ti ti-tool text-blue-500" /> Détails de l'intervention
                    </h2>
